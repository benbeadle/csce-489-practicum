...
Google Charts isn't not the only web-oriented chart tools. While I was researching, I came across a really good [comparison](http://designfestival.com/visualize-your-data-and-speed-up-your-site-with-dynamic-chart-libraries/) of Google Charts vs D3 and more.
